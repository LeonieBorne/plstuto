Please note that the following contributors' guidelines are directly inspired by the one used for the [STEMM Role Models App](https://github.com/KirstieJane/STEMMRoleModels).
